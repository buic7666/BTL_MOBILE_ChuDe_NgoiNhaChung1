                ...
                Column(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.home_filled, size: 44, color: AppColors.bgWhite),
                    ),
                      ...
                      child: DecoratedBox(
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [const Color.fromARGB(255, 6, 45, 239), const Color.fromARGB(255, 42, 7, 241)],
                        ...
                        child: ElevatedButton.icon(
                          ...
                          icon: const Icon(Icons.add, color: Color.fromARGB(255, 241, 237, 237)),
                          label: const Text(
                            'Tạo Nhà Mới',
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            elevation: 0,
                            foregroundColor: const Color.fromARGB(255, 247, 246, 248),
                          ),
                        ),
                      ),
                    ),
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        style: OutlinedButton.styleFrom(
                          padding: const EdgeInsets.symmetric(vertical: 16),
                          side: const BorderSide(color: Color.fromARGB(255, 13, 5, 235), width: 1.5),
                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
                          backgroundColor: const Color.fromARGB(255, 13, 5, 235),
                        ),
                      ),
                    ),
                  ],
