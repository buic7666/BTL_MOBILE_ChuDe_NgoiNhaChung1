            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        validator: (v) {
                          if (v == null || v.trim().isEmpty) return 'Vui lòng nhập tên nhà';
                ...
                SizedBox(
                  ...
                  child: DecoratedBox(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(colors: [const Color.fromARGB(255, 22, 107, 245), const Color.fromARGB(255, 31, 66, 162)]),
                      borderRadius: BorderRadius.circular(12),
                    ),
                    child: ElevatedButton(
                      ...
                      child: const Text('Tạo ngay', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold,color: AppColors.textPrimary)),
                    ),
                  ),
                ),
            ...
            child: Column(
              ...
              children: [
                ...
                if (address.isNotEmpty) ...[
                  const SizedBox(height: 8),
                  Text(address, textAlign: TextAlign.center, style: const TextStyle(color: AppColors.textSecondary)),
                ],
                const SizedBox(height: 32),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: const Color.fromARGB(255, 14, 14, 14).withOpacity(0.3),
                      width: 2,
                    ),
                  ),
                  child: Column(
                ...
                const SizedBox(height: 24),
                  SizedBox(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: const Color.fromARGB(255, 13, 9, 249), // Thêm màu cho nút đẹp hơn (tùy chọn)
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                    ),
                    child: const Text(
                      'Xong', 
                      style: TextStyle(fontWeight: FontWeight.w600, color: Color.fromARGB(255, 9, 9, 9))
                    ),
                  ),
                ),
              ],
